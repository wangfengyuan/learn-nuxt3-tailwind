<template>
    <div class="card bg-blue mt-4">
        <div class="relative overflow-hidden">
            <div class="w-8 h-8 bg-eye absolute top-0 left-0 bg-cover">
            </div>
            <div class="absolute top-0 right-0 h-6  text-light-gray flex">
        ...
        <div class="p-4 text-white min-h-[126px] flex flex-col justify-between">
            <p class="line-clamp-2">Elite Royale Pass for Season 13 Elite Royale Pass for Season 13 Elite Royale Pass for Season 13</p>
            <p class="text-[18px] text-gold">6.99 USD</p>
        </div>
    </div>
</template>